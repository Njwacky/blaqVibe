...
type PendingCall = { name: string; callId: string; args: Record<string, unknown>; output?: string };
...
export class TuiRenderer {
  ...
  constructor(opts: RendererOptions) {
    ...
    this.toolColors = { shell: RED, file_write: YELLOW, file_edit: YELLOW, web_search: MAGENTA, ...opts.toolColors };
  }
