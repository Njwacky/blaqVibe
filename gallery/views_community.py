...
def nolo_chat_api(request):
    try:
        ...
        from .nolo_context import public_chat_context
        # The only live data Nolo sees: what the public chat page already shows.
        answer, source, meta = get_nolo_ai_answer(prompt, return_meta=True, context=public_chat_context())
